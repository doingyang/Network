...
public class UploadRequestBody extends RequestBody {
    ...
    public UploadRequestBody(File file, TransformProgressListener progressListener) {
        this.mRequestBody = RequestBody.create(MediaType.parse("multipart/form-data"), file);
        this.mProgressListener = progressListener;
    }

    public UploadRequestBody(RequestBody requestBody, TransformProgressListener progressListener) {
        this.mRequestBody = requestBody;
        this.mProgressListener = progressListener;
    }

    // 返回了requestBody的类型，像form-data/MP3/MP4/png等等等格式
    @Override
